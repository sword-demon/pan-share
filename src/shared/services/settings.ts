...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    {
      name: 'aliyun_oss',
      title: t('groups.aliyun_oss'),
      description: 'custom your Aliyun OSS settings',
      tab: 'storage',
    },
    {
      name: 'openrouter',
...
export async function getSettings() {
  ...
  "premium-yearly": "prod_xxx"
    ...
    // Aliyun OSS settings
    {
      ...
      tip: 'OSS region, e.g., oss-cn-hangzhou, oss-cn-shanghai, oss-cn-beijing',
      group: 'aliyun_oss',
      tab: 'storage',
    },
    {
    ...
    },
    {
      ...
      tip: 'Leave empty to use the default OSS endpoint. Format: https://{region}.aliyuncs.com (without bucket name)',
      group: 'aliyun_oss',
      tab: 'storage',
    },
    {
      name: 'oss_public_domain',
      title: 'Public Domain',
      type: 'url',
      placeholder: 'https://cdn.example.com',
      tip: 'Custom domain for public access (CDN domain recommended)',
      group: 'aliyun_oss',
      tab: 'storage',
    },
    {
      name: 'oss_internal',
      title: 'Use Internal Endpoint',
      type: 'switch',
      tip: 'Use internal endpoint for servers in the same region (faster and free)',
      group: 'aliyun_oss',
      tab: 'storage',
    },
    {
